#
# build.tcl: Tcl script for re-creating project 'vcu118_hpc1_qgige_axieth'
#
#*****************************************************************************************
...
set design_name vcu118_hpc1_axieth
...
set file "[file normalize "$origin_dir/src/constraints/vcu118-hpc1.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constraints/vcu118-hpc1.xdc"
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/src/constraints/vcu118-hpc1.xdc"]" $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xcvu9p-flga2104-2L-e -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
